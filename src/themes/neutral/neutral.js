...
/**
 * neutral theme — built by `bunx astryx theme build`
...
export const neutralTheme = {
  ...
  tokens: {
    ...
    "--color-data-categorical-blue": "light-dark(#0171E3, #4a92eb)",
    "--color-data-categorical-orange": "light-dark(#EB6E00, #d1762b)",
    "--color-data-categorical-teal": "light-dark(#08A3A3, #39a593)",
    "--color-data-categorical-purple": "light-dark(#6B1EFD, #895196)",
    "--color-data-categorical-pink": "light-dark(#F351C0, #d76395)",
