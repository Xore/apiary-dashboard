...
export const navItems: NavItem[] = [
  {
    ...
    items: [
      ...
      { icon: 'Sparkles', label: 'ML anomalies', href: '/ml-anomalies' },
      { icon: 'MessageSquare', label: 'LLM analysis', href: '/llm-analysis' },
      { icon: 'User', label: 'Agent campaigns', href: '/agent-campaigns' },
      { icon: 'Lock', label: 'Auth-failure events', href: '/auth-events' },
    ]
  },
  {
    groupLabel: 'Investigate',
    items: [
      { icon: 'List', label: 'Event explorer', href: '/events' },
      { icon: 'Globe', label: 'Attack sources', href: '/ips' },
      { icon: 'Users', label: 'Campaigns', href: '/campaigns' },
      { icon: 'Boxes', label: 'Infrastructure clusters', href: '/clusters' },
      { icon: 'UserSearch', label: 'Attacker identities', href: '/attackers' },
      { icon: 'GitBranch', label: 'Kill-chain analytics', href: '/kill-chain' },
      { icon: 'Terminal', label: 'Executed commands', href: '/commands' },
      { icon: 'Cpu', label: 'Sensor detail', href: '/sensors' },
      { icon: 'PlayCircle', label: 'Session recordings', href: '/recordings' },
      { icon: 'Search', label: 'Hash / IOC lookup', href: '/investigate/lookup' },
    ]
  },
  {
    ...
    items: [
      ...
      { icon: 'Activity', label: 'Source & pipeline health', href: '/source-health' },
      { icon: 'Network', label: 'Fleet topology', href: '/topology' },
      { icon: 'Clock', label: 'Event history', href: '/history' },
    ]
  },
  {
  ...
  { groupLabel: 'Reports', items: [{ icon: 'FileText', label: 'Reports studio', href: '/reports' }] },
  { groupLabel: 'Tools', items: [{ icon: 'Shield', label: 'Canarytokens', href: '/canarytokens' }, { icon: 'Search', label: 'Analysis results', href: '/analysis' }] },
  { groupLabel: 'Recent', items: [{ label: 'EXAMPLE' }] }
]
