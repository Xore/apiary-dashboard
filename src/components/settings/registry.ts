...
export const SETTINGS: Setting[] = [
  ...
  { id: 'session', panel: 'account', title: 'Session', description: 'How you signed in.', icon: KeyIcon, keywords: 'oidc login' },
  { id: 'signOut', panel: 'account', title: 'Sign out', description: 'Ends your session here and at the identity provider.', icon: ArrowRightStartOnRectangleIcon, keywords: 'logout log out' },
  { id: 'accountProfile', panel: 'account', title: 'Profile & password', description: 'Account details, password change, and recovery email.', icon: UserIcon, keywords: 'keycloak password change email' },
  { id: 'accountSecurity', panel: 'account', title: 'Passkeys & two-factor authentication', description: 'Register hardware keys, authenticator apps, and WebAuthn credentials.', icon: FingerPrintIcon, keywords: 'keycloak 2fa mfa otp webauthn passkey totp' },
